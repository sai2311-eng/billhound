...
![BillHound architecture](docs/architecture.png)
...
The PNG is generated by [`docs/make_architecture.py`](docs/make_architecture.py), so it
cannot drift from the graph without someone editing that script too.
